...
# Available state files
{
    ...
    # Projector Control
    $MON_FILES{'PROJECTOR_CTRL_COLOR'} = 'LINE-NOUPDATE';
    $MON_FILES{'PROJECTOR_CTRL_LIFE'}  = 'LINE-NOUPDATE';
    $MON_FILES{'PROJECTOR_CTRL_POWER'} = 'LINE-NOUPDATE';
    $MON_FILES{'PROJECTOR_CTRL_TIMER'} = 'LINE-NOUPDATE';
    ...
    $MON_FILES{'OIL_ENABLE'} = 'EXISTS-NOUPDATE';
