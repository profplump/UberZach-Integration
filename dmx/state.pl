...
# Available state files
{
	...
	$MON_FILES{'PROJECTOR_COLOR'} = 'VALUE-NOUPDATE';
	$MON_FILES{'PROJECTOR_INPUT'} = 'VALUE-NOUPDATE';
	$MON_FILES{'PROJECTOR_LAMP'}  = 'VALUE-NOUPDATE';

	# Amplifier
	$MON_FILES{'AMPLIFIER'}       = 'STATUS';
	$MON_FILES{'AMPLIFIER_VOL'}   = 'VALUE-NOUPDATE';
	$MON_FILES{'AMPLIFIER_MODE'}  = 'VALUE-NOUPDATE';
	$MON_FILES{'AMPLIFIER_INPUT'} = 'VALUE-NOUPDATE';
